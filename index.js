...
export const LOGGER_ACTIONS = createPrivateEnum(
	'IDENT', 'DEENT',
	'LOG', 'WARNING', 'DEPRECATED', 'ERROR', 'DEBUG', 'TIME_START','TIME_END');
...
loggerLogger = new Logger('logger'); // CCCCombo!
